...
Security & Data Engineer — detection engineering, identity & access management, and the data pipelines that power them. Nearly 4 years building production infrastructure at Meta. Based in New York, open to remote.

- 🔍 Focused on: detection engineering, osquery, SIEM fundamentals, IAM/SSO, Python/SQL data pipelines
- 🎓 Working toward: CompTIA Security+
- 💼 Previously: Enterprise Systems Engineer & IT Support Engineer @ Meta / Facebook
...
**Identity & Access:** IAM, MFA, SSO, DUO, FIDO2, Active Directory, Google Workspace

**Data & Automation:** Python, SQL (Hive, Presto), Bash, PowerShell, ETL pipeline design, CI/CD
